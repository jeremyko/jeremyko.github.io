...
이미 작성되어 있는 python 코드를 그대로 실행 가능하고 java , python 간에 데이터를 주고 받게 해서 연동 할 수 있다. **pandas, numpy 등 C 에 종속된 특정 python 모듈 사용에도 제약이 없다는 큰 장점**을 가지고 있다. 
...
https://github.com/ninia/jep/wiki/Numpy-Usage  
https://github.com/ninia/jep/issues/560  
